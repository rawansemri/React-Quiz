...
import { FetchChemistry } from "../../redux/Chemistry/actions";
...
const Chemisrty = () => {
  ...
  const { Questions, loading } = useSelector((state) => state.chemistryReducer);
  ...
  if (loading)
    return (
      <>
        <div>
          <p className={styles.title}>Chemisrty Quiz</p>
        </div>
        <p>Loading Quiz...</p>
      </>
    );
  return (
    <div>
      ...
      <form className={styles.chemisrtyForm} onSubmit={handleSubmit}>
        {isDone ? (
          <>
